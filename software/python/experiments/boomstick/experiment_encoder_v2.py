...
# jumping dict
N = 2
jump_counter = np.linspace(1, 4, 4)
launch_velocity = np.array([2.8])
touchdown_r = 0.15
touchdown_theta = np.radians(95)
staging_r = 0.14
staging_theta = np.array(np.radians([115]))
exertion_d = 0.06
flight_r = 0.17
...
# N = 2
# jump_counter = np.linspace(1, 4, 4)
# launch_velocity = np.array([2.8, 2.8, 2.8, 2.8, 2.8])
# touchdown_r = 0.15
# touchdown_theta = np.radians(95)
# staging_r = 0.14
# staging_theta = np.array(np.radians([115, 115, 115, 115, 115]))
# exertion_d = 0.06
# flight_r = 0.17
# flight_theta = np.array(np.radians([87, 87, 87, 87, 87]))
...
if OMP:
    ...
    # launch_velocity = np.array([2.78227764, 1.84129489, 2.8, 2.18657339, 2.8, 2.78330593, 2.8, 2.61335334, 1.81888153,
    #                             2.10661335, 2.8, 1.5, 2.8])
    # launch_velocity = np.array([2.78227764, 1.84129489, 2.8, 2.56940137, 2.43511281, 2.8, 2.8, 1.5, 2.68642519,
    #                             2.40207603, 2.8, 2.78210094, 1.5])
    # des_theta = np.array(np.radians([65, 65, 65, 65, 65, 65, 75.8531148, 65, 65, 65, 65, 65, 65]))
    staging_theta = np.radians(180) - des_theta
    # contact_sequence_x = np.array([0, 0.70342607, 1.01053507, 1.76457341, 2.23675427, 2.9479089, 3.65178206, 3.96818556,
    #                                4.72970582, 5.03, 5.42219523, 6.21446112, 6.48884597, 7.2000006])
    # contact_sequence_x = np.array([0, 0.70342607, 1.01053507, 1.7645734, 2.37899966, 2.94092289, 3.65207753, 3.96850282,
    #                                4.34306397, 5.00553983, 5.43, 6.22226589, 6.92561515, 7.2])
    # contact_sequence_z = np.array([0, 0, 0.1, 0, 0, 0, 0, 0.35, 0, 0, 0.2, 0, 0, 0])
