...
obstacle_1_polynom, h1 = obstacle_builder(position=0.5, height=0.2, width=0.1)
obstacle_1_polynom_c, h1 = obstacle_builder(position=0.5, height=0.2, width=0.2)
g = 9.80665
x0 = 0
z0 = 0
xg = 1
